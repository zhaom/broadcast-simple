...
public abstract class AbstractHttpRPCService {
	...
	private HttpRPCResult invokeRPC(String requestUrl, String method,
	        Map<String, String> header, byte[] requestContent,
	        int expectantStatus) {
	 ...
	 */
	protected HttpRPCResult invokePost(String URI, Map<String, String> header,
	        byte[] requestContent, int expectantStatus) {
		return invokeRPC(URI, "POST", header, requestContent,
		        expectantStatus);
	}
	 ...
	 * @return HTTP RPC result object
	 */
	protected HttpRPCResult invokePut(String URI, Map<String, String> header,
	        byte[] requestContent, int expectantStatus) {
		return invokeRPC(URI, "PUT", header, requestContent,
		        expectantStatus);
	}
