...
<div class="middle" style="width:902px;margin:0 auto;padding-top:10px;">
  ...
  <iframe allowtransparency="true" framespacing="0" frameborder="0" scrolling="auto" width="760" height="510" src="<%=path%>/queryMyMessageList.action" id="main" name="main" target="_self"></iframe>
</div>
