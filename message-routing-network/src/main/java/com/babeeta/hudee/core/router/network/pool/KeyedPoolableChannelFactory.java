...
final class KeyedPoolableChannelFactory implements KeyedPoolableObjectFactory {
	...
	public KeyedPoolableChannelFactory(TrackingThreadPool bossExecutorService,
	...
	public void destroyObject(Object key, Object obj) throws Exception {
		...
		if (obj != null && channel.isConnected()) {
			logger.debug(
			        "Connection {} will be closed. Total connection = {}",
	...
	public Object makeObject(Object key) throws Exception {
		...
		if (channelFuture.isSuccess()) {
			logger.debug(
			        "New connection for {} is connected. ID:{}, Total connection = {}",
			        new Object[] { key,
